...
Wave 4 — 5 new features per package across 8 packages, plus a dropdown-menu polish fix.
...
- Pause-on-hover — hovering any toast pauses *every* toast's auto-dismiss timer (`pauseOnHover` on `ToastProvider`, default true).
