  ...
  return (
    <PropPlayground layout="stacked"
      ...
      props={[
        ...
        { name: "showToolbar",       group: "Display",     control: { type: "toggle" },                                                    defaultValue: true,      omitWhen: true },
        { name: "wordCount",         group: "Display",     control: { type: "toggle" },                                                    defaultValue: false,     omitWhen: false },
        { name: "showUndoRedo",      group: "Display",     label: "undo/redo items",  control: { type: "toggle" },                         defaultValue: false,     omitWhen: false },
        { name: "showCodeItem",      group: "Display",     label: "code toolbar item", control: { type: "toggle" },                        defaultValue: false,     omitWhen: false },
        { name: "sanitizePaste",     group: "Behaviour",   control: { type: "toggle" },                                                    defaultValue: true,      omitWhen: true },
        { name: "shortcuts",         group: "Behaviour",   control: { type: "toggle" },                                                    defaultValue: true,      omitWhen: true },
        { name: "defaultLinkPrompt", group: "Behaviour",   control: { type: "segmented", options: ["popover","prompt"] as const },         defaultValue: "popover", omitWhen: "popover" },
        { name: "bubbleMenu",        group: "Behaviour",   control: { type: "toggle" },                                                    defaultValue: false,     omitWhen: false },
        { name: "autoLink",          group: "Behaviour",   control: { type: "toggle" },                                                    defaultValue: false,     omitWhen: false },
        { name: "disabled",          group: "Behaviour",   control: { type: "toggle" },                                                    defaultValue: false,     omitWhen: false },
        { name: "required",          group: "Behaviour",   control: { type: "toggle" },                                                    defaultValue: false,     omitWhen: false },
        { name: "invalid",           group: "Behaviour",   control: { type: "toggle" },                                                    defaultValue: false,     omitWhen: false },
        { name: "label",             group: "Content",     control: { type: "text", placeholder: "e.g. Bio" },                             defaultValue: "",        omitWhen: "" },
        { name: "hint",              group: "Content",     control: { type: "text", placeholder: "Markdown supported" },                   defaultValue: "",        omitWhen: "" },
        { name: "error",             group: "Content",     control: { type: "text", placeholder: "Required" },                             defaultValue: "",        omitWhen: "" },
        { name: "name",              group: "Content",     control: { type: "text", placeholder: "form field name" },                      defaultValue: "",        omitWhen: "" },
        { name: "placeholderEachLine", group: "Content",   control: { type: "text", placeholder: "Type here…" },                          defaultValue: "",        omitWhen: "" },
        { name: "maxChars",          group: "Content",     control: { type: "number", min: 0, max: 1000, step: 50 },                       defaultValue: 0,         omitWhen: 0 },
        { name: "maxWords",          group: "Content",     control: { type: "number", min: 0, max: 500, step: 10 },                        defaultValue: 0,         omitWhen: 0 },
      ]}
