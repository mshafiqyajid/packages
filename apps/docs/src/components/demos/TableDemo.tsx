  ...
  return (
    <PropPlayground layout="stacked"
      ...
      props={[
        ...
        { name: "striped",            group: "Appearance", control: { type: "toggle" }, defaultValue: false, omitWhen: false },
        { name: "bordered",           group: "Appearance", control: { type: "toggle" }, defaultValue: false, omitWhen: false },
        { name: "hoverable",          group: "Appearance", control: { type: "toggle" }, defaultValue: true,  omitWhen: true },
        { name: "selectable",         group: "Behaviour",  control: { type: "segmented", options: ["off","single","multi","range"] as const }, defaultValue: "off", omitWhen: "off" },
        { name: "multiSort",          group: "Behaviour",  control: { type: "toggle" }, defaultValue: false, omitWhen: false },
        { name: "expandableRows",     group: "Behaviour",  label: "expandable rows",    control: { type: "toggle" }, defaultValue: false, omitWhen: false },
        { name: "editableName",       group: "Behaviour",  label: "editable name col",   control: { type: "toggle" }, defaultValue: false, omitWhen: false },
        { name: "showFooter",         group: "Display",    control: { type: "toggle" }, defaultValue: true,  omitWhen: false },
        { name: "showDensityToggle",  group: "Display",    control: { type: "toggle" }, defaultValue: true,  omitWhen: false },
        { name: "showColumnMenu",     group: "Display",    control: { type: "toggle" }, defaultValue: true,  omitWhen: false },
        { name: "exportable",         group: "Display",    control: { type: "toggle" }, defaultValue: true,  omitWhen: false },
        { name: "highlightMatches",   group: "Display",    control: { type: "toggle" }, defaultValue: true,  omitWhen: false },
        { name: "bulkActions",        group: "Display",    label: "bulk actions bar",    control: { type: "toggle" }, defaultValue: false, omitWhen: false },
        { name: "groupByRole",        group: "Display",    label: "groupBy role",        control: { type: "toggle" }, defaultValue: false, omitWhen: false },
        { name: "loading",            group: "Display",    control: { type: "toggle" }, defaultValue: false, omitWhen: false },
        { name: "ariaGrid",           group: "Display",    control: { type: "toggle" }, defaultValue: false, omitWhen: false },
      ]}
